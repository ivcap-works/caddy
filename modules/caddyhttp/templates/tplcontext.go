...
func (c TemplateContext) funcHTTPInclude(uri string) (string, error) {
	...
	virtReq.RemoteAddr = "127.0.0.1:10000" // https://github.com/ivcap-works/caddy/issues/5835
	virtReq.Header = c.Req.Header.Clone()
	virtReq.Header.Set("Accept-Encoding", "identity") // https://github.com/ivcap-works/caddy/issues/4352
